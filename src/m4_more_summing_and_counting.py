...
def run_test_factorial():
    ...
    answer_from_oracle = math.factorial(28)
    answer_from_my_code = factorial(28)
    print('Test 3 expected (from oracle):', answer_from_oracle)
    print('       actual (from my code): ', answer_from_my_code)

    answer_from_oracle = math.factorial(31)
    answer_from_my_code = factorial(31)
    print('Test 4 expected (from oracle):', answer_from_oracle)
    print('       actual (from my code): ', answer_from_my_code)

    answer_from_oracle = math.factorial(99)
    answer_from_my_code = factorial(99)
...
def run_test_count_cosines_from():
    ...
    expected = 0
    answer = count_cosines_from(3, 5, 0.5)
    ...
    expected = 3
    answer = count_cosines_from(5, 8, 0.2)
